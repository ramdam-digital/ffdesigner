...
class NewsletterWidget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        if (stripos($instance['text'], '<form') === false) {
            ...
            $form .= '<p>
                        <input class="newsletter-email" type="email" required name="ne" value="' . $options_profile['email'] . '" onclick="if (this.defaultValue==this.value) this.value=\'\'" onblur="if (this.value==\'\') this.value=this.defaultValue"/>
                        <input type="submit" class="newsletter-bouton" value="OK">
                    </p>';
